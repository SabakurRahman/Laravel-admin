    ...
    <div class="card-body">
        <div class="row align-items-end">
            <div class="col-md-3">
                ...
                {!! Form::text('question_title', isset($filters['question_title']) ? $filters['question_title'] : null, ['class'=>'form-control form-control-sm']) !!}
            </div>
            <div class="col-md-3">
                {!! Form::label('status') !!}
                {!! Form::select('status', \App\Models\Faq::STATUS_LIST, isset($filters['status']) ? $filters['status'] : null, ['class'=>'form-control form-control-sm','placeholder'=>'select status']) !!}
            </div>
            {{-- <div class="col-md-3">
                {!! Form::label('faq_page') !!}
                {!! Form::select('faq_page_id', $faqPageOptions,isset($filters['faq_page_id']) ? $filters['faq_page_id'] : null, ['class'=>'form-control form-control-sm']) !!}
            </div> --}}
            <div class="col-md-3">
                {!! Form::label('Per page') !!}
