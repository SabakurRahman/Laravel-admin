...
<div class="card">
    <div class="card-body">
        <div class="row align-items-end">
            ...
            <div class="col-md-3">
                {!! Form::label('status') !!}
                {!! Form::select('status', \App\Models\Faq::STATUS_LIST, isset($filters['status']) ? $filters['status'] : null, ['class'=>'form-control form-control-sm']) !!}
            </div>
            <div class="col-md-3">
                <label for="our_approach_category_id">Approach Category</label>
                <select name="our_approach_category_id" id="project_category_id" class="form-control">
                    <option value="" disabled selected>Select a category</option>
                    @foreach($all_approachCategory as $category)
