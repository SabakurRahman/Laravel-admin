...
<div class="card">
    <div class="card-body">
        <div class="row align-items-end">
            ...
            <div class="col-md-3">
                {!! Form::label('serial') !!}
                {!! Form::number('serial', isset($filters['serial']) ? $filters['serial'] : null, ['class'=>'form-control form-control-sm']) !!}
            </div>
            <div class="col-md-3">
                {!! Form::label('Type') !!}
                {!! Form::select('type', \App\Models\EstimateCategory::TYPES_LIST, isset($filters['type']) ? $filters['type'] : null, ['class'=>'form-control form-control-sm','placeholder'=>'select type']) !!}
            </div>
            	
            <div class="col-md-3">
                {!! Form::label('status') !!}
                {!! Form::select('status', \App\Models\EstimateCategory::STATUS_LIST, isset($filters['status']) ? $filters['status'] : null, ['class'=>'form-control form-control-sm','placeholder'=>'select status']) !!}
            </div>
            <div class="col-md-3">
                {!! Form::label('Per page') !!}
            ...
            <div style="margin:15px auto 0 auto!important"class="col-md-3">
                <div class="row">
                    <div class="col-md-6">
                        <div class="d-grid">
