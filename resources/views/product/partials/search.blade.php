...
<div class="card">
    <div class="card-body">
        <div class="row align-items-end">
            ...
            <div class="col-md-3">
                {!! Form::label('sku') !!}
                {!! Form::text('sku', isset($filters['sku']) ? $filters['sku'] : null, ['class'=>'form-control form-control-sm']) !!}
            </div>
            <div class="col-md-3">
                {!! Form::label('model') !!}
                {!! Form::text('model', isset($filters['model']) ? $filters['model'] : null, ['class'=>'form-control form-control-sm']) !!}
            </div>
            <div class="col-md-3">
                {!! Form::label('Product Type') !!}
                {!! Form::select('product_type', \App\Models\Product::PRODUCT_TYPE_LIST, isset($filters['product_type']) ? $filters['product_type'] : null, ['class'=>'form-control form-control-sm', 'placeholder'=>'Select Type']) !!}
            </div>
            <div class="col-md-3">
                {!! Form::label('Per page') !!}
