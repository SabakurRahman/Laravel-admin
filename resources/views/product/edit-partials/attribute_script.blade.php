    ...
    <script>
            ...
            <div class="col-md-11">
                ...
                <div class="col-md-6">
                    <label class="w-100 mb-0">
                        ...
                        <select name="attribute[${index}][attribute_id]" type="text" class="form-select">
        ...
        const prepareOptions = (data, attribute= undefined) => {
            ...
            for (const [key, value] of Object.entries(data)) {
                options += `<option ${attribute != undefined  && attribute.attribute_id == key ? 'selected' : ''} value="${key}">${value}</option>`
            }
            return options
        }
