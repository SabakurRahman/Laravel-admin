...
<div class="card">
    <div class="card-body">
        <div class="row align-items-end">
            ...
            <div class="col-md-3">
                {!! Form::label('Name Bn') !!}
                {!! Form::text('name_bn', isset($filters['name_bn']) ? $filters['name_bn'] : null, ['class'=>'form-control form-control-sm']) !!}
            </div>
            <div class="col-md-3">
                {!! Form::label('Attribute Name') !!}
                {!! Form::select('attribute_id',$attributeOptions, isset($filters['attribute_id']) ? $filters['attribute_id'] : null, ['class'=>'form-control form-control-sm']) !!}
            </div>


            <div class="col-md-3">
                {!! Form::label('status') !!}
                {!! Form::select('status', \App\Models\Category::STATUS_LIST, isset($filters['status']) ? $filters['status'] : null, ['class'=>'form-control form-control-sm']) !!}
            </div>
            <div class="col-md-3">
                {!! Form::label('Per page') !!}
