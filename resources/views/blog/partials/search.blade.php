...
<div class="card">
    <div class="card-body">
        <div class="row align-items-end">
            ...
            <div class="col-md-3">
                {!! Form::label('status') !!}
                {!! Form::select('status', \App\Models\BlogPost::STATUS_LIST, isset($filters['status']) ? $filters['status'] : null, ['class'=>'form-control form-control-sm']) !!}
            </div>
            <div class="col-md-3">
                {!! Form::label('type') !!}
                {!! Form::select('type', \App\Models\BlogPost::BLOG_TYPE,isset($filters['type']) ? $filters['type'] : null, ['class'=>'form-control form-control-sm']) !!}
            </div>
            <div class="col-md-3">
                {!! Form::label('Per page') !!}
            ...
            <div class="col-md-3">
                ...
                {!! Form::select('category_id', $categories, isset($filters['category_id']) ? $filters['category_id'] : null, ['class'=>'form-select form-select-sm', 'placeholder'=>'Select Category']) !!}
            </div>
            <div class="col-md-3">
                {!! Form::label('Sort by') !!}
