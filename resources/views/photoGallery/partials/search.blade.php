...
<div class="card">
    <div class="card-body">
        <div class="row align-items-end">
            ...
            <div class="col-md-3">
                {!! Form::label('status') !!}
                {!! Form::select('status', \App\Models\PhotoGallerie::STATUS_LIST, isset($filters['status']) ? $filters['status'] : null, ['class'=>'form-control form-control-sm','placeholder'=>'select status']) !!}
            </div>
            <div class="col-md-3">
                {!! Form::label('Show on Slider') !!}
                {!! Form::select('is_shown_on_slider', \App\Models\PhotoGallerie::SLIDER_LIST, isset($filters['is_shown_on_slider']) ? $filters['is_shown_on_slider'] : null, ['class'=>'form-control form-control-sm','placeholder'=>'Select location']) !!}
            </div>
            <div class="col-md-3">
                {!! Form::label('Per page') !!}
