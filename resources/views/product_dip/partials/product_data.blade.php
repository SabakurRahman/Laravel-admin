...
{{--        </div>--}}
    ...
    <div class="row align-items-center">
        <div class="col-md-6 mt-3">
            ...
            {!! Form::select('inventory_method', \App\Models\Inventory::INVENTORY_TRACK_LIST, null, [
                'class' => 'form-select',
        ...
        <div class="col-md-6 mt-3">
            {!! Form::label('low_sotck_quanity', 'Low Stock Quantity') !!}
            {!! Form::number('low_sotck_quanity', null, [
                'class' => 'form-control',
        ...
        <div class="col-md-6 mt-3">
            ...
            {!! Form::number('min_cart_quantity', null, [
                'class' => 'form-control',
        ...
        <div class="col-md-6 mt-3">
            ...
            {!! Form::number('max_cart_quantity', null, [
                'class' => 'form-control',
        ...
        <div class="col-md-6 mt-3">
            ...
            {!! Form::number('allowed_quantity', null, [
                'class' => 'form-control',
        ...
        <div class="col-md-6 mt-3">
            ...
            {!! Form::date('available_alert_date', null, ['class' => 'form-control', 'placeholder' => 'Available alert date']) !!}
        </div>
        <div class="col-md-6 mt-3">
    ...
    <div class="row">
        ...
        <div class="col-md-6 mt-3">
            <div
                ...
                {!! Form::checkbox('disable_buy_button', 1, null, ['class' => 'form-check-input', 'id' => 'disable_buy_button']) !!}
...
{{--                {!! Form::checkbox('is_enable_call_for_price', 1, null, ['class' => 'form-check-input', 'id' => 'is_enable_call_for_price']) !!}--}}
...
{{--                {!! Form::checkbox('is_available_for_pre_order', 1, null, [--}}
...
{{--                {!! Form::checkbox('customer_enters_price', 1, null, [--}}
{{--                    'class' => 'form-check-input',--}}
...
{{--        </div>--}}
        <div class="col-md-6 mt-3">
            <div
                ...
                {!! Form::checkbox('is_tax_exempt', 1, null, ['class' => 'form-check-input', 'id' => 'is_tax_exempt']) !!}
...
{{--                {!! Form::checkbox('is_telecommunications_services', 1, null, [--}}
{{--                    'class' => 'form-check-input',--}}
...
{{--                {!! Form::checkbox('disable_wishlist_button', 1, null, [--}}
{{--                    'class' => 'form-check-input',--}}
...
{{--        </div>--}}
        ...
        <div class="col-md-6 mt-3">
            <div
                ...
                {!! Form::checkbox('is_returnable', 1, null, [
                    'class' => 'form-check-input',
                    'id' => 'is_returnable',
                ]) !!}
