    ...
    <div class="row justify-content-center my-5">
        <div class="col-md-4">
            <label class="w-100 mb-0">
                Please Select Images ({{\App\Models\ProductPhoto::PRODUCT_PHOTO_WIDTH}}px X {{\App\Models\ProductPhoto::PRODUCT_PHOTO_HEIGHT}}px)
...
@include('modules.product.partials.variant_script')
<div class="d-none" id="photo_container" data-photos="{{json_encode($product->photo)}}"></div>
@include('modules.product.edit-partials.image_upload_script')
