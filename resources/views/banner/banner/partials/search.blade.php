...
<div class="card">
    <div class="card-body">
        <div class="row align-items-end">
            <div class="col-md-3">
                {!! Form::label('Name') !!}
                {!! Form::text('title', isset($filters['title']) ? $filters['title'] : null, ['class'=>'form-control form-control-sm']) !!}
            </div>
            <div class="col-md-3">
                {!! Form::label('Type') !!}
                {!! Form::text('type', isset($filters['type']) ? $filters['type'] : null, ['class'=>'form-control form-control-sm']) !!}
            </div>
            <div class="col-md-3">
                {!! Form::label('Serial') !!}
                {!! Form::text('serial', isset($filters['serial']) ? $filters['serial'] : null, ['class'=>'form-control form-control-sm']) !!}
            </div>
            <div class="col-md-3">
                {!! Form::label('Banner size') !!}
                {!! Form::select('banner_size_id', $bannerSizeOptions, isset($filters['banner_size_id']) ? $filters['banner_size_id'] : null, ['class' => 'form-control form-control-sm','placeholder'=>'Select Banner Size']) !!}
            </div>
            <div class="col-md-3">
                {!! Form::label('Location') !!}
            ...
            <div class="col-md-3">
                {!! Form::label('status') !!}
                {!! Form::select('status', \App\Models\Banner::STATUS_LIST, isset($filters['status']) ? $filters['status'] : null, ['class'=>'form-control form-control-sm','placeholder'=>'Select Status']) !!}
            </div>
            <div class="col-md-3">
                {!! Form::label('Per page') !!}
