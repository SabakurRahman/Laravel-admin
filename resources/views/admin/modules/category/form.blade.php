...
<fieldset>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            {!! Form::select('status', \App\Models\Category::STATUS_LIST , null, ['class'=>'form-select', 'placeholder'=>'Select Status']) !!}
        </div>
        <div class="col-md-6">
            ...
            {!! Form::select('category_id',
                ...
                old('category_id', isset($category) ? $category->category_id : null),
                ['class' => 'form-select']
            ) !!}
       </div>
        <div class="col-md-12">
        ...
        <div class="col-md-6">
            ...
            <div class="photo-preview-area">
                ...
                <img
                    src="{{isset($category->photo) ? asset(\App\Models\Category::PHOTO_UPLOAD_PATH.$category->photo)  : asset('uploads/canvas.webp')}}"
        ...
        <div class="col-md-6">
            ...
            <div class="photo-preview-area" style="width: 250px; height: 150px">
                ...
                <div class="overly"></div>
                <img
                    src="{{isset($category->banner) ? asset(\App\Models\Category::BANNER_UPLOAD_PATH.$category->banner)  : asset('uploads/canvas.webp')}}"
                    alt="photo display area" class="photo photo-preview-area-photo"/>
            </div>
        </div>
...
<fieldset class="mt-4">
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            {!! Form::text('meta_title',$category->seos->title ?? null, ['class'=>'form-control', 'placeholder'=>'Enter blog category title']) !!}
        </div>

        <div class="col-md-6">
            {!! Form::label('meta_title_bn', 'Seo Title_bn') !!}
            {!! Form::text('meta_title_bn',$category->seos->title_bn ?? null, ['class'=>'form-control', 'placeholder'=>'Enter seo title bn']) !!}
        </div>
        <div class="col-md-6">
            {!! Form::label('meta_keywords', 'Keywords') !!}
            {!! Form::text('meta_keywords', $category->seos->keywords ?? null, ['class'=>'form-control', 'placeholder'=>'Enter Keywords']) !!}
        </div>

        <div class="col-md-6">
            {!! Form::label('meta_keywords_bn', 'Keywords bn') !!}
            {!! Form::text('meta_keywords_bn', $category->seos->keywords_bn ?? null, ['class'=>'form-control', 'placeholder'=>'Enter Keywords bn']) !!}
        </div>
        <div class="col-md-6">
            {!! Form::label('meta_description', 'Seo Description ') !!}
            {!! Form::text('meta_description', $category->seos->description ?? null, ['class'=>'form-control', 'placeholder'=>'Enter Seo Description']) !!}
        </div> <div class="col-md-6">
            {!! Form::label('meta_description_bn', 'Seo Description bn ') !!}
            {!! Form::text('meta_description_bn', $category->seos->description_bn ??null, ['class'=>'form-control', 'placeholder'=>'Enter Seo Description bn ']) !!}
        </div>
        ...
        <div class="col-md-8">
            ...
            <div class="photo-preview-area" style="width: 250px; height: 150px">
                ...
                <div class="overly"></div>
                <img
                    src="{{isset($category?->seos?->og_image) ? asset(\App\Models\Seo::Seo_PHOTO_UPLOAD_PATH . $category?->seos?->og_image)  : asset('uploads/canvas.webp')}}"
                    alt="photo display area" class="photo photo-preview-area-photo"/>
            </div>
        </div>
    </div>
