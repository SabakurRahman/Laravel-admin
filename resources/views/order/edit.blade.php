...
@section('content')
    ...
    <form action="{{ route('order.update', ['order' => $order->id]) }}" method="POST" id="quick_order_form">
        @csrf
        @method('put')
        <div class="row">
            <div class="col-md-6">
                <div class="card quick-order-card mb-4">
                    <div class="card-body">
                        ...
                        <div class="row align-items-center mb-2">
                            <div class="col-md-4">
                                <label class="form-label" for="basicpill-firstname-input">Invoice Number </label>
                            </div>
                            <div class="col-md-8">
                                {{$order->invoice_no}}
                            </div>
                ...
                <div class="card quick-order-card mb-4">
                    ...
                    <div class="card-body">
                        <div class="row align-items-center mb-2">
                            ...
                            <div class="col-md-8">
                                <input type="text" class=" form-control" id="basicpill-firstname-input"
                                       name="customer_name" value="{{ old('customer_name') ?? $order?->user?->name ?? null }}"
                        ...
                        <div class="row align-items-center mb-2">
                            ...
                            <div class="col-md-8">
                                <input type="text" class=" form-control" id="basicpill-firstname-input"
                                       name="phone_number" value="{{ old('phone_number') ?? $order?->user?->phone ?? null }}"
...
{{--                                {{ old('address') }}--}}
            ...
            <div class="col-md-12 text-center">
                <button id="save_order" type="submit" class="btn btn-success">Update Order</button>
    ...
    <div class="d-none" id="data_selected_product" data-selected-product="{{json_encode($order->order_items)}}"></div>
