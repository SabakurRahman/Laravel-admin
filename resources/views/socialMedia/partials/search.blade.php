...
<div class="card">
    <div class="card-body">
        <div class="row align-items-end">
            ...
            <div class="col-md-3">
                {!! Form::label('Url') !!}
                {!! Form::text('url', isset($filters['url']) ? $filters['url'] : null, ['class'=>'form-control form-control-sm']) !!}
            </div>
            <div class="col-md-3">
                {!! Form::label('status') !!}
                {!! Form::select('status', \App\Models\SocialMedia::STATUS_LIST, isset($filters['status']) ? $filters['status'] : null, ['class'=>'form-control form-control-sm','placeholder'=>'Select Status']) !!}
            </div>
            <div class="col-md-3">
                {!! Form::label('Per page') !!}
