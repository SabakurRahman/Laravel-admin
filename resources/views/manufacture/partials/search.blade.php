    ...
    <div class="card-body">
        <div class="row align-items-end">
            ...
            <div class="col-md-3">
                ...
                {!! Form::text('description', isset($filters['description']) ? $filters['description'] : null, ['class'=>'form-control form-control-sm']) !!}
            </div>
            <div class="col-md-3">
                {!! Form::label('serial') !!}
            ...
            <div class="col-md-3">
                {!! Form::label('status') !!}
                {!! Form::select('status', \App\Models\Manufacture::STATUS_LIST, isset($filters['status']) ? $filters['status'] : null, ['class'=>'form-control form-control-sm','placeholder'=>'Select Status']) !!}
            </div>
            <div class="col-md-3">
                {!! Form::label('Per page') !!}
