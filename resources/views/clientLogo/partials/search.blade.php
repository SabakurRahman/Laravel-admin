...
<div class="card">
    <div class="card-body">
        <div class="row align-items-end">
            ...
            <div class="col-md-3">
                {!! Form::label('Location') !!}
                {!! Form::select('status', \App\Models\ClientLogo::STATUS_LIST, isset($filters['status']) ? $filters['status'] : null, ['class'=>'form-control form-control-sm','placeholder'=>'Select Location']) !!}
            </div>
            <div class="col-md-3">
                {!! Form::label('Per page') !!}
