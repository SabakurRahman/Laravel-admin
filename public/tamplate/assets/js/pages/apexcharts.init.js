...
options = {
    ...
    series: [
        {
            name: "Quantity",
            data: [34, 40, 90, 28, 52, 42, 109, 100, 50, 20, 200, 100],
        },
...
(chart = new ApexCharts(
    document.querySelector("#sales_by_date"),
    options
)).render();
    ...
    series: [
        {
            ...
            data: [45, 52, 38, 24, 33, 26, 200, 20, 6, 8, 15, 10],
        },
        {
            name: "Total price",
            data: [
                1000, 1500, 2000, 2500, 3000, 1800, 2200, 1600, 1200, 1800,
                1300, 1400,
            ],
        },
    ],
...
var chart = new ApexCharts(document.querySelector("#top_customers"), options);
chart.render();
...
//         toolbar: { show: !1 },
//     },
//     colors: ["#f9c341", "#34c38f"],
//     dataLabels: { enabled: 1 },
//     stroke: { width: [4, 3], curve: "straight", dashArray: [0, 0] },
//     series: [
//         {
//             name: "Page Views",
...
var options = {
    series: [
        ...
        {
            name: "Total price",
            data: [1000, 1500, 2000, 2500, 3000, 1800],
        },
    ],
    chart: {
        height: 350,
...
(chart = new ApexCharts(
    document.querySelector("#top_product"),
    options
)).render();
